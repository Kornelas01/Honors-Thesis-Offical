...
```{r}
ggplot(Prejune_FFD_weather, aes(FFD, January)) +
  geom_point() +
  geom_smooth(method = "lm")
...
```{r}
ggplot(Prejune_FFD_weather, aes(FFD, February)) +
  geom_point() +
  geom_smooth(method = "lm")
...
```{r}
ggplot(Prejune_FFD_weather, aes(FFD, March)) +
  geom_point() +
  geom_smooth(method = "lm")
...
April
```{r}
ggplot(Prejune_FFD_weather, aes(FFD, April)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE)
...
May
```{r}
ggplot(Prejune_FFD_weather, aes(FFD, May)) +
  geom_point() +
  geom_smooth(method = "lm")
